export const day10Scenes = [
  ...
  },
  {
    ...
    "role": "동급생",
    "place": "같은 우산",
    "text": "학범이 우산 아래로 한 걸음 들어오자 현겸의 시선이 젖은 어깨에 오래 머물렀다. 그는 손잡이를 학범 쪽으로 기울이며 낮게 말했다. 혼자 돌아가지 말라는 말은 질투처럼 조용히 빗소리에 섞였다.",
  ...
  },
  {
    ...
    "role": "학생회 기록 담당",
    "place": "아카이브 원본",
    "text": "학범이 카드의 빈칸에 손을 얹자 상원은 펜 끝을 멈췄다. 그는 선택을 말로 흘려보내지 않겠다는 듯 학범의 이름 옆에 얇은 선을 남겼다. 지우지 않을 증거가 조용히 기록 속으로 들어갔다.",
  ...
  },
  {
    ...
    "role": "동급생",
    "place": "같은 우산",
    "text": "현겸의 기다림은 다정해서 오히려 조용한 질투를 숨기고 있었다. 학범은 우산 아래의 좁은 거리를 떠올리며, 이제 혼자 돌아가겠다는 말로 그를 세워 두지 않겠다고 적었다.",
  ...
  },
  {
    ...
    "role": "학생회 기록 담당",
    "place": "아카이브 원본",
    "text": "출입 명단의 빈칸이 상원의 손끝 아래에서 멈췄다. 학범은 자신의 선택을 증거로 남기려는 그 고집을 피하지 않고, 빈칸에 스스로 이름을 남기겠다고 마음먹었다.",
    "nextId": "day10-locked-merge",
    "directives": [
      {
        "type": "BCG",
