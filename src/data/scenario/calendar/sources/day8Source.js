export const day8Scenes = [
  ...
  },
  {
    ...
    "role": "독백",
    "place": "학생회 기록실",
    "text": "축제 리허설 공지 앞에서 학범은 종이꽃 냄새를 맡았다. “업무표 말고 약속표처럼 보이네.” 빈칸마다 오늘 만나고 싶은 이름이 떠올랐다.",
    "nextId": "day8-free-hub-a",
    "directives": [
      {
        "type": "BCG",
        "src": "/assets/bg/archive-club-room-evening.png",
    ...
    "variants": [
      {
        ...
        "text": "조 편성표 앞에서 현겸이 학범 이름을 찾는 속도가 조금 빨랐다. 학범은 리본보다 그 짧은 안도부터 봤다."
      }
    ],
    "effect": {
      "target": "hyeongyeom",
    ...
    "variants": [
      {
        ...
        "text": "욱현은 전시 순서를 읽다 학범이 오는 쪽에 손가락을 멈췄다. 학범은 종이보다 기다리던 시선을 먼저 마주쳤다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "재성은 큐시트를 흔들며 웃었지만 첫 멘트는 늦었다. 학범은 장난보다 그가 숨긴 긴장을 먼저 들었다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "상원은 명단 한 칸을 비워 둔 채 펜을 굴렸다. 학범은 기록보다 허락을 기다리는 손끝을 먼저 봤다."
      }
    ],
    "effect": {
      "target": "sangwon",
    ...
    "variants": [
      {
        ...
        "text": "상욱은 무대 뒤 계단에서 한 발을 들었다가 내려놨다. 학범은 속도보다 자신을 기다리는 버릇을 먼저 알아챘다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "준혁은 최단 동선을 그어 놓고도 돌아가는 길에 별표를 붙였다. 학범은 계산보다 남겨 둔 시간을 먼저 읽었다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "도훈은 부스 가격표를 붙이다 학범 쪽을 힐끗 봤다. 학범은 숫자보다 괜히 붉어진 귀를 먼저 발견했다."
      }
    ],
    "effect": {
      "target": "dohun",
    ...
    "variants": [
      {
        ...
        "text": "하음은 리허설 첫 음을 누르기 전에 학범 쪽을 봤다. 학범은 악보보다 같이 시작하려는 숨을 먼저 들었다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "윤호는 안내 표지판을 바로잡고도 그 자리에 남아 있었다. 학범은 방향보다 자신을 기다리는 작은 욕심을 먼저 봤다."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "role": "독백",
    "place": "학생회 기록실",
    "text": "학범은 빈 페이지 맨 위에 적었다. “내가 미루지 말아야 할 말.” 리허설 조명이 꺼진 뒤에도, 오늘 받은 대답들은 축제 음악처럼 남았다.",
    "directives": [
      {
        "type": "BCG",
        "src": "/assets/bg/archive-club-room-evening.png",
