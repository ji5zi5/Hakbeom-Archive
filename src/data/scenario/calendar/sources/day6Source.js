export const day6Scenes = [
  ...
  },
  {
    ...
    "role": "독백",
    "place": "학생회 기록실",
    "text": "학범은 문제집을 덮고 휴대폰을 보았다. “오늘은 업무 핑계 말고, 내가 먼저 누군가의 옆자리로 가도 되겠지.” 기록집보다 먼저 심장이 답했다.",
    "nextId": "day6-free-hub-a",
    "directives": [
      {
        "type": "BCG",
        "src": "/assets/bg/archive-club-room-evening.png",
  ...
  },
  {
    ...
    "role": "학생회",
    "place": "중정 벤치",
    "text": "현겸은 작은 수건과 빵을 내밀며 “먼저 먹어”라고 했고, 욱현은 노트 세 줄만 표시해 학범 쪽으로 밀었다. 재성은 “학범 표정은 방송 금지”라고 웃었고, 하음은 “숨부터 맞추자”라며 메트로놈을 낮췄다.",
    "directives": [
      {
        "type": "BCG",
  ...
  },
  {
    ...
    "role": "동급생",
    "place": "중정 벤치",
    "text": "현겸은 젖은 우산 자국을 닦을 수건을 책상 아래에 깔고, 빵 봉지를 학범 손목 가까이에 밀었다. “네가 또 아침 건너뛰었지. 안 물어볼 테니까, 일단 한 입만.”",
    "directives": [
      {
        "type": "BCG",
        "src": "/assets/bg/school-courtyard-blue-hour.png",
  ...
  },
  {
    ...
    "role": "학생회",
    "place": "중정 벤치",
    "text": "학범은 빵 봉지를 열며 현겸의 손등에 남은 물기를 보았다. “나 힘든 거 티 났어?” 현겸이 대답을 미루자 학범은 수건 끝을 잡아당겼다. “그럼 오늘은 네가 챙겨 준 거, 안 모른 척할게.”",
    "variants": [
      {
        "requiredFlags": [
          "hyeongyeom_route_seed"
        ],
        "text": "학범은 우산 손잡이를 책상 옆에 세워 둔 현겸의 손끝부터 확인했다. “내 옆자리 비워 둔 거, 공부 때문만은 아니지?”"
      }
    ],
    "effect": {
      "target": "hyeongyeom",
  ...
  },
  {
    ...
    "role": "동급생",
    "place": "중정 벤치",
    "text": "현겸은 빵 봉지 끝을 접어 학범 쪽으로 눌러 주었다. “기다리는 건 할 수 있어. 그런데 네가 괜찮은 척하는 건 못 본 척하기 싫어.” 목소리는 낮았고, 우산 아래보다 거리는 더 가까웠다."
  },
  {
    ...
    "role": "동급생",
    "place": "중정 벤치",
    "text": "현겸은 우산을 가져가려다 다시 돌아와 학범 손등에 펜 끝을 톡 찍었다. “오늘은 내가 챙긴 거, 네가 잊지 않았으면 좋겠어.” 학범은 그 점을 지우지 않고 손을 오므렸다."
  },
  {
  ...
  },
  {
    ...
    "role": "학생회",
    "place": "중정 벤치",
    "text": "학범은 책상에 남은 수건을 접어 가방 앞주머니에 넣었다. 내일 돌려줄 핑계가 생겼고, 현겸이 먼저 챙긴 마음을 이번엔 학범이 먼저 찾아가기로 했다.",
    "effect": {
      "target": "hyeongyeom",
      "type": "ellipsis"
    }
  ...
  },
  {
    ...
    "role": "동급생",
    "place": "중정 벤치",
    "text": "현겸에게 먼저 밥 먹었다고 말하자, 그는 짧게 웃고는 “그럼 오늘은 내가 한 가지는 도운 거네”라고 답했다. 학범은 그 말이 빈말보다 오래 남는다고 생각했다.",
    "directives": [
      {
        "type": "BCG",
        "src": "/assets/bg/school-courtyard-blue-hour.png",
  ...
  },
  {
    ...
    "role": "독백",
    "place": "학생회 기록실",
    "text": "학범은 기록장 아래에 적었다. “도움을 받는 것도 데이트의 일부.” 웃음이 났다. 오늘 받은 시선과 말들은 문제집보다 오래 남았다.",
    "directives": [
      {
        "type": "BCG",
        "src": "/assets/bg/archive-club-room-evening.png",
