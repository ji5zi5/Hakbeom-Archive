...
const beatTexts = {
  day6: {
    ...
    hyeongyeom: {
      place: '비 그친 복도 창가',
      bg: '/assets/bg/school-rain-hallway.png',
    ...
    ukhyun: {
      place: '도서관 창가',
      bg: '/assets/bg/library-window.png',
    ...
    jaeseong: {
      place: '방송실',
      bg: '/assets/bg/broadcast-room.png',
    ...
    sangwon: {
      place: '학생회 기록실',
      bg: '/assets/bg/student-council-room-evening.png',
    ...
    sanguk: {
      place: '체육관 복도',
      bg: '/assets/bg/gym-corridor-evening.png',
    ...
    junhyeok: {
      place: '도서관 지도 테이블',
      bg: '/assets/bg/archive-club-room-evening.png',
    ...
    dohun: {
      place: '편의점 앞 테이블',
      bg: '/assets/bg/convenience-store-night.png',
  ...
  day7: {
    ...
    hubLead: '갑작스러운 비와 소문 때문에 복도는 평소보다 시끄러웠다. 학범은 누구에게 괜찮다고 말할지, 누구의 불안을 먼저 만질지 선택해야 했다.',
    prompt: ['소문의 첫 반응을 누구에게 확인할까?', '비가 세질 때 누구의 곁에 설까?', '마지막으로 누구에게 괜찮다고 말할까?'],
    hyeongyeom: {
      place: '젖은 복도 끝',
      bg: '/assets/bg/school-rain-hallway.png',
      entry: '학범아, 네 이름 옆에 내 이름 붙은 거 봤어. 기분 나쁜 건 아닌데… 네가 불편하면 내가 먼저 떼어낼게.',
      answer: '불편한 건 소문이야. 네 이름이 옆에 있는 건 싫지 않아.',
    ...
    ukhyun: {
      place: '비 내리는 도서관',
      bg: '/assets/bg/library-window.png',
      entry: '소문은 문장 구조가 나빠. 주어도 목적어도 흐려. 그런데 네 표정은 흐리지 않네.',
    ...
    jaeseong: {
      place: '방송실 문 앞',
      bg: '/assets/bg/broadcast-room.png',
      entry: '소문 정정 방송 해줄까? “학범이는 아직 아무한테도 고백 안 했습니다. 단, 후보자는 긴장하세요.” 이렇게.',
    ...
    sangwon: {
      place: '학생회 기록실',
      bg: '/assets/bg/student-council-room-evening.png',
      entry: '소문이 퍼진 경로는 적어 뒀어. 그런데 학범아, 네 마음까지 내가 적으면 안 되는 거겠지.',
    ...
    junhyeok: {
      place: '계단참 지도 앞',
      bg: '/assets/bg/archive-club-room-evening.png',
      entry: '소문 확산 속도는 빠른데 근거는 약해. 문제는 네가 약한 근거에도 상처받는다는 거고.',
    ...
    dohun: {
      place: '편의점 처마 아래',
      bg: '/assets/bg/convenience-store-night.png',
      entry: '소문 출처 알아냈다. 말해 줄 수도 있는데, 지금 네 표정 보니까 먼저 단거 먹여야겠네.',
    ...
    yunho: {
      place: '옥상 계단',
      bg: '/assets/bg/rooftop-after-rain.png',
      entry: '선배, 소문 들었어요. 저는 괜찮아요. 아니, 괜찮은 척은 할 수 있어요.',
  ...
  day9: {
    ...
    title: '소문이 번진 방과 후',
    hubLead: '소문은 더 커졌지만, 이제 학범은 기록 뒤에 숨을 수 없었다. 마음이 향하는 사람마다 확인하고 싶은 말이 달랐다.',
    prompt: ['소문 때문에 흔들린 사람을 먼저 만난다.', '방과 후 약속을 직접 확인한다.', '밤이 오기 전 마지막 말을 남긴다.'],
    hyeongyeom: {
      place: '비 오기 전 교문',
      bg: '/assets/bg/school-rain-hallway.png',
      entry: '다들 네가 누구한테 고백할지 맞히느라 바쁘더라. 나는 맞히기보다, 네가 도망치지 않았으면 좋겠어.',
      answer: '도망 안 갈게. 그리고 현겸아, 네 앞에서는 더 숨기고 싶지 않아.',
      reaction: '현겸은 우산 끈을 만지작거렸다. “그럼 내가 기다려도 되는 거지? 네가 말할 때까지, 너무 멀리 가지 않고.”',
      close: '학범은 고개를 끄덕였다. “기다리게만 하지 않을게. 나도 네 쪽으로 갈 거야.”',
      high: '현겸은 조용히 웃었다. “그 말이면 오늘은 충분해. 내일은 조금 더 욕심낼게.”'
    },
    ukhyun: {
      place: '닫히기 전 도서관',
      bg: '/assets/bg/library-window.png',
      entry: '소문은 접으면 작아져. 그런데 네 마음은 접지 마. 작아 보이면 내가 못 읽어.',
    ...
    jaeseong: {
      place: '방송실 야간등',
      bg: '/assets/bg/broadcast-room.png',
      entry: '소문 정정하려고 대본까지 썼는데, 네가 오니까 전부 유치해 보인다. 그냥 물어볼게. 나, 기다려도 돼?',
    ...
    dohun: {
      place: '밤의 편의점',
      bg: '/assets/bg/convenience-store-night.png',
      entry: '소문 때문에 네가 밥 거를 줄 알았다. 그래서 샀어. 계산은 내가 했고, 고마우면 나중에 제대로 웃어라.',
    ...
    haeum: {
      place: '무대 뒤 음악실',
      bg: '/assets/bg/music-room-late-afternoon.png',
      entry: '소문은 박자가 빨라. 네 마음은 그 속도에 맞추지 않아도 돼. 학범아, 네 템포로 말해.',
