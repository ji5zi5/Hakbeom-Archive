export const day7Scenes = [
  ...
  },
  {
    ...
    "name": "문화제 준비 채팅방",
    "role": "메시지",
    "text": "등교 직후 문화제 준비 채팅방에는 일정보다 서로의 속마음이 먼저 올라왔다.",
    "messages": [
      {
        "from": "sangwon",
        "text": "매점 쿠폰 시간보다 학범 표정부터 봐. 말이 커지면 제일 먼저 피곤해지는 건 학범이야."
      },
      {
        "from": "dohun",
        "text": "영수증은 장식 아님. 근데 오늘은 내가 농담으로 덮기 전에 먼저 물어볼게. 괜찮냐?"
      },
      {
        "from": "haeum",
        "text": "문 닫히는 소리는 두 번이었어. 급해서가 아니라, 누군가 학범을 기다리느라 멈춘 소리였을 수도 있어."
      },
      {
        "from": "hakbeom",
  ...
  },
  {
    ...
    "role": "학생회 기록 담당",
    "place": "학생회 기록실",
    "text": "상원은 “네 표정을 지키려면 말투부터 정리해야 해”라고 했고, 준혁은 칠판 한쪽에 학범이 쉴 수 있는 동선을 남겼다. 현겸이 “그럼 학범 마음은 누가 물어봐?”라고 묻자 방 안이 조용해졌다.",
    "directives": [
      {
        "type": "BCG",
        "src": "/assets/bg/archive-club-room-evening.png",
  ...
  },
  {
    ...
    "role": "운동부",
    "place": "체육관 복도",
    "text": "상욱은 복도로 뛰쳐나가려다 학범이 부르자 멈췄고, 윤호는 후배가 끼어들면 방해가 될까 봐 문턱에서 기다렸다. 도훈은 농담을 삼켰고, 재성은 “오늘은 웃기 전에 진심부터 말하자”고 했다.",
    "directives": [
      {
        "type": "BCG",
  ...
  },
  {
    ...
    "role": "동급생",
    "place": "중정 벤치",
    "text": "하음은 학범의 손이 떨리는 박자를 먼저 짚었고, 현겸은 괜찮다는 말 뒤에 숨지 말라고 낮게 말했다. 욱현은 노트 가장자리를 접지 않고 펼쳐 두었고, 준혁은 계산 대신 의자를 하나 더 빼 두었다.",
    "directives": [
      {
        "type": "BCG",
  ...
  },
  {
    ...
    "role": "독백",
    "place": "학생회 기록실",
    "text": "학범은 모두를 진정시키려다 자신이 또 중재자 자리로 물러났다는 걸 깨달았다. 그는 펜을 내려놓고 말했다. “오늘은 내가 누구 걱정을 대신 떠안을지보다, 누구 곁에 있고 싶은지 말할게.”",
    "directives": [
      {
        "type": "BCG",
        "src": "/assets/bg/archive-club-room-evening.png",
    ...
    "variants": [
      {
        ...
        "text": "빗소리가 커지자 현겸은 우산을 조금 더 학범 쪽으로 기울였다. 학범은 물방울보다 가까워진 어깨를 먼저 의식했다."
      }
    ],
    "effect": {
      "target": "hyeongyeom",
    ...
    "variants": [
      {
        ...
        "text": "욱현은 젖은 책갈피를 소매로 닦아 내밀었다. 학범은 책보다 그가 조심히 접어 둔 말에 먼저 눈이 갔다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "재성은 마이크 대신 젖은 대본을 흔들었다. 학범은 농담보다 낮아진 목소리에 먼저 멈춰 섰다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "상원은 기록집이 젖지 않게 품에 안고 있었다. 학범은 페이지보다 그가 비워 둔 옆자리를 먼저 봤다."
      }
    ],
    "effect": {
      "target": "sangwon",
    ...
    "variants": [
      {
        ...
        "text": "상욱은 뛰어오려다 물웅덩이 앞에서 멈췄다. 학범은 빠른 발보다 기다리느라 움찔한 손을 먼저 알아챘다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "준혁은 젖은 지도 모서리를 눌러 펴며 학범을 기다렸다. 학범은 길보다 일부러 남긴 여백을 먼저 읽었다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "도훈은 편의점 봉투를 비 맞지 않는 쪽으로 옮겼다. 학범은 영수증보다 “따뜻할 때 마셔”라는 투덜거림을 먼저 들었다."
      }
    ],
    "effect": {
      "target": "dohun",
    ...
    "variants": [
      {
        ...
        "text": "하음은 빗방울 박자에 맞춰 손끝을 멈췄다. 학범은 악보보다 자신을 기다리는 그 느린 호흡을 먼저 느꼈다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "윤호는 옥상 문을 잠그지 않고 난간 쪽에 서 있었다. 학범은 표지판보다 돌아보는 눈빛을 먼저 따라갔다."
      }
    ]
  },
  {
