export const day9Scenes = [
  ...
  },
  {
    ...
    "role": "학생회",
    "place": "학생회 기록실",
    "text": "축제 준비 명단이 도착하자 학범은 한숨 대신 웃었다. “다들 같은 시간대네. 결국 오늘도 내가 직접 만나서 말해야겠구나.”",
    "nextId": "day9-free-hub-a",
    "directives": [
      {
        "type": "BCG",
        "src": "/assets/bg/archive-club-room-evening.png",
  ...
  {
    "id": "day9-moe-hyeongyeom-everyone-kind",
    "type": "dialogue",
    "mood": "warm",
    "chapter": "day-9",
    "name": "현겸",
    "role": "동급생",
    "place": "교실 뒤편",
    "text": "현겸은 책상 모서리를 손끝으로 문지르다 물었다. “학범아, 너는 누구에게나 이렇게 다정해? 대답하기 어렵다면 천천히 해도 돼. 그래도 난 듣고 싶어.”",
    "effect": {
      "target": "hyeongyeom",
      "type": "blush"
    },
  ...
  {
    "id": "day9-moe-ukhyun-unread-sentence",
    "type": "dialogue",
    "mood": "warm",
    "chapter": "day-9",
    "name": "욱현",
    "role": "도서위원",
    "place": "도서관 창가",
    "text": "욱현은 접힌 노트를 펴지 않고 학범에게 돌려주었다. “읽지 않은 문장도 보여. 그래도 오늘은 추측 안 할게. 네가 말해 주면 좋겠어.”",
    "effect": {
      "target": "ukhyun",
      "type": "ellipsis"
    },
  ...
  },
  {
    ...
    "role": "매점 정보통",
    "place": "매점 앞",
    "text": "도훈은 장난을 치려다 캔 뚜껑만 만지작거렸다. “네가 누구한테 다정한지 궁금한 거 아냐. 그냥… 나한테도 조금은 특별했으면 좋겠다는 뜻이지.”",
    "effect": {
      "target": "dohun",
      "type": "blush"
    },
  ...
  },
  {
    ...
    "role": "학생회 기록 담당",
    "place": "학생회 기록실",
    "text": "상원은 축제 준비 명단과 비어 있던 결재표를 나란히 놓았다. 두 종이의 빈칸은 서로 다른 종이인데도 같은 모양으로 비어 있었다.",
    "nextId": "day9-merge-prep",
    "directives": [
      {
        "type": "BCG",
  ...
  },
  {
    ...
    "role": "독백",
    "place": "축제 준비 복도",
    "text": "축제 준비는 문화제 준비를 숨기지 않았다. 오히려 사람들을 한곳에 모아, 학범이 더 이상 선택을 미룰 수 없게 만들고 있었다.",
    "directives": [
      {
        "type": "BCG",
  ...
  },
  {
    ...
    "role": "동급생",
    "place": "같은 우산",
    "text": "“학범아, 오늘 네가 웃는 척하는 거 티 나.” 현겸의 말은 작았지만 가장 먼저 우산을 기울여 주는 사람처럼 다정했다. 학범은 그 걱정을 준비보다 먼저 받아들였다.",
    "variants": [
      {
        "requiredFlags": [
          "hyeongyeom_route_seed"
        ],
        "text": "소문이 번지는 동안에도 현겸은 학범 옆에서 우산을 접지 않았다. 시끄러운 복도에서 그 조용한 고집만 또렷했다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "욱현은 노트를 닫고 학범 쪽으로 한 발 다가왔다. 주변이 떠들수록 접히지 않은 그 메모 한 장이 더 분명해졌다."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "role": "독백",
    "place": "접힌 노트",
    "text": "학범은 욱현과 나란히 침묵을 읽었다. 문화제 준비는 누가 놀렸느냐보다, 누가 말하지 못하게 만들었느냐를 묻는 쪽으로 기울었다."
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "재성은 마이크 전원을 꺼 둔 채 학범을 불렀다. 방송실 밖 소란보다 낮게 낮춘 목소리가 먼저 닿았다."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "role": "독백",
    "place": "방송 신호",
    "text": "학범은 재성의 농담이 어디에서 멈추는지 처음으로 들었다. 스피커 잡음 너머에는 장난보다 먼저 숨겨 둔 진심이 있었다."
  },
  {
    ...
    "role": "학생회 기록 담당",
    "place": "문화제 기록집",
    "text": "문화제 기록집의 수정 이력에는 상원이 모르는 공백 한 줄이 끼어 있었다. 상원은 펜을 내려놓고, 학범의 선택이 자기 기록 밖에서 조용히 바뀌는 순간을 붙잡지 못할까 두려워했다.",
    "directives": [
      {
        "type": "BCG",
        "src": "/assets/bg/archive-club-room-evening.png",
  ...
  },
  {
    ...
    "role": "학생회 기록 담당",
    "place": "문화제 기록집",
    "text": "“학범, 오늘 누구 앞에서 웃는 척했는지 다 티 나.” 상원의 말은 장난처럼 시작했지만 끝에는 기록을 덮는 듯한 집착이 남았다. 학범은 그 걱정을 준비보다 먼저 받아들였다.",
    "variants": [
      {
        "requiredFlags": [
          "sangwon_route_seed"
        ],
        "text": "상원은 기록집을 덮고 학범의 대답을 기다렸다. 정리되지 않은 침묵이 오히려 오늘의 표시가 됐다."
      }
    ]
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "상욱은 뛰어오지 않고 학범 앞에서 숨을 골랐다. 복도 소음보다 참느라 느려진 발끝이 먼저 보였다."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "role": "독백",
    "place": "체육관 동선",
    "text": "학범은 상욱의 성급함이 도망이 아니라 도착 방식이라는 걸 알았다. 누가 먼저 마음을 숨겼든, 상욱은 학범이 뒤처지는 순간부터 이미 방향을 바꾸고 있었다."
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "준혁은 지도 위 경로를 지우지 않은 채 학범을 봤다. 계산식 바깥에 남긴 빈칸이 이상하게 오래 눈에 밟혔다."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "role": "독백",
    "place": "지도 위 빈칸",
    "text": "학범은 준혁이 숫자를 내려놓을 때 더 정확해진다는 걸 보았다. 문화제 준비의 빈칸은 논리로 좁아졌지만, 마음의 빈칸은 기다림으로만 좁아졌다."
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "도훈은 영수증을 접었다 펴며 괜히 투덜거렸다. 매점 앞 소란보다 “밥은 먹었냐”는 말이 더 또렷했다."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "role": "독백",
    "place": "매점 쿠폰 시간",
    "text": "학범은 도훈의 장난이 가벼워서가 아니라 무거운 걸 들어 올리려고 튀어 오른다는 걸 알았다. 문화제 준비는 아직 차가웠지만, 캔 따는 소리는 둘 사이를 조금 데웠다."
  },
  {
    ...
    "variants": [
      {
        ...
        "text": "하음은 피아노 뚜껑을 닫고 학범의 숨을 기다렸다. 주변 박수가 멀어질 만큼 그 짧은 정적이 길었다."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "role": "후배 / 풍기 도우미",
    "place": "마른 종이",
    "text": "“선배, 오늘 괜찮은 척하는 거... 조금 티 났어요.” 윤호의 말은 조심스럽게 시작했지만 끝에는 기다림이 남았다. 학범은 그 걱정을 준비보다 먼저 받아들였다.",
    "variants": [
      {
        "requiredFlags": [
          "yunho_route_seed"
        ],
        "text": "윤호는 옥상 문고리를 잡고도 뒤로 물러서지 않았다. 바람보다 먼저 들린 건, 이름을 부르려다 삼킨 숨이었다."
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "role": "학생회",
    "place": "학생회 기록실",
    "text": "축제 준비가 끝난 뒤, 학범은 아홉 갈래 표시 옆에 작은 동그라미를 남겼다. 내일 해야 할 말은 무거웠지만, 더는 남의 문장을 맞히는 일이 아니었다.",
