export const day12Scenes = [
  ...
  },
  {
    ...
    "role": "학생회",
    "place": "축제 리허설장",
    "text": "학범은 리허설장 이름표를 정리하며 중얼거렸다. “무대가 대신 말해 주진 않겠지.” 그래서 오늘은 대사보다 먼저, 눈을 마주치는 연습을 하기로 했다.",
    "directives": [
      {
        "type": "BCG",
        "src": "/assets/bg/school-courtyard-blue-hour.png",
  ...
  },
  {
    ...
    "role": "학생회",
    "place": "무대 뒤",
    "text": "커튼 뒤에는 꽃가루가 흩어져 있었다. 학범은 그것을 사건처럼 보지 않기로 했다. “넘어진 사람 있으면, 내가 먼저 손 내밀면 돼.”",
  ...
  },
  {
    ...
    "role": "학생회",
    "place": "방송실",
    "text": "방송실 리허설 로그에는 학범 이름이 세 번이나 연습용으로 남아 있었다. 장난처럼 들렸지만, 누군가 오늘도 그 이름을 조심스럽게 불렀다는 뜻이었다.",
    "nextId": "day12-after-check",
    "directives": [
      {
        "type": "BCG",
  ...
  },
  {
    ...
    "role": "학생회",
    "place": "학생회 기록실",
    "text": "기록집을 복사하자 빈 줄이 또렷하게 남았다. 학범은 그 줄에 연필로 적었다. “고백은 기록보다 먼저, 사람을 보고 말하기.”",
    "nextId": "day12-after-check",
    "directives": [
      {
        "type": "BCG",
  ...
  },
  {
    ...
    "role": "독백",
    "place": "복도",
    "text": "세 장소에서 돌아온 학범은 알았다. 오늘 필요한 건 이유를 캐묻는 일이 아니라, 리허설이 끝난 뒤에도 기다려 준 사람에게 제대로 대답하는 일이었다."
  },
  {
    "id": "day12-closing",
    "type": "dialogue",
